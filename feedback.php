  ...
  <div class="col-md-6 bg-light form-box">
    <form action="includes/feedback.inc.php" method="POST">
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <select class="mt-4" name="2"
            style="border: 0px; border-bottom: 2px solid #fff; background-color: transparent !important; font-weight: bold !important; color: white !important; width:100%" required>
      ...
      <div class="row">
      <h5 class="ml-3">How would you rate your experience?</h5>
...
<footer>
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Hello Flight</h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Developed By Hello Flight</p>
</footer>